                                        ...
                                        <ul class="list-unstyled contact-list">
                                            ...
                                            @if (!empty($information['personal_info']['phone_number']))
                                                <li class="phone">
                                                    Marital Status
                                                    <a class="ms-3"
                                                        href="tel:{{ isset($information['personal_info']['marital_status']) ? $information['personal_info']['marital_status'] : '' }}">{{ isset($information['personal_info']['marital_status']) ? $information['personal_info']['marital_status'] : '' }}</a>
                                                </li>
                                            @endif
